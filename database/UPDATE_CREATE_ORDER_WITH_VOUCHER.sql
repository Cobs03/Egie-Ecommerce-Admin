-- ============================================
-- UPDATE create_order_from_cart TO SUPPORT VOUCHERS
-- ============================================
-- This updates the function to accept voucher parameters
-- and properly calculate totals with voucher discounts
-- ============================================
...
DO $$ 
BEGIN
  RAISE NOTICE '✅ create_order_from_cart() function updated!';
